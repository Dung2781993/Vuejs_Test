        ...
        },
        {
          ...
          value: function bindEvents() {
            ...
            if (options.mouseDrag) {
              ...
              $panel.on(
                SlidePanel.eventName("dragstart selectstart"),
        ...
        },
        {
          ...
          value: function getHidePosition() {
            ...
            switch (options.direction) {
              ...
              case "bottom":
                return parseFloat(
                  -(this._length / (0, _jquery2.default)(window).height()) *
                    100,
                  10
                );
              case "left":
