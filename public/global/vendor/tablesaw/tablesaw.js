...
(function(factory) {
      ...
      this.$table
        ...
        .each(function() {
          ...
          $(self.tablesaw._findPrimaryHeadersForCell(this)).each(function(
            ...
            $newHeader.append(
              $sortableButton.length
                ? $sortableButton[0].childNodes
                : $header[0].childNodes
            );
          });
  ...
  (function() {
    ...
    ColumnToggle.prototype.updateColspanIgnoredRows = function(
      invisibleColumnCount,
      $cells
    ) {
      this.$table
        .find(
          "[" + this.attributes.subrow + "],[" + this.attributes.ignorerow + "]"
        )
        .each(function() {
          var $t = $(this);
    ...
    function createSwipeTable(tbl, $table) {
      ...
      function getNext() {
        ...
        $headerCellsNoPersist.each(function(i) {
          var $t = $(this),
            isHidden =
              $t.css("display") === "none" || $t.is(".tablesaw-cell-hidden");
