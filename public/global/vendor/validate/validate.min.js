  ...
  (e.extend = function(a) {
    ...
    e.extend(d, {
      ...
      isDomElement: function(a) {
        return a &&
          e.isFunction(a.querySelectorAll) &&
          e.isFunction(a.querySelector)
      ...
      collectFormValues: function(a, b) {
        ...
        for (
          b = b || {},
            f = a.querySelectorAll("input[name], textarea[name]"),
            c = 0;
          c < f.length;
          ++c
        )
          (d = f.item(c)),
            e.isDefined(d.getAttribute("data-ignored")) ||
              ((g = e.sanitizeFormValue(d.value, b)),
              "number" === d.type
                ? (g = g ? +g : null)
                : "checkbox" === d.type
                ? d.attributes.value
                  ? d.checked || (g = h[d.name] || null)
                  : (g = d.checked)
                : "radio" === d.type && (d.checked || (g = h[d.name] || null)),
              (h[d.name] = g));
        for (f = a.querySelectorAll("select[name]"), c = 0; c < f.length; ++c)
          (d = f.item(c)),
            (g = e.sanitizeFormValue(d.options[d.selectedIndex].value, b)),
            (h[d.name] = g);
        return h;
      },
    ...
    (d.validators = {
      presence: function(a, b) {
        return (
          ...
          e.isEmpty(a) ? b.message || this.message || "can't be blank" : void 0
        );
      },
      ...
      numericality: function(a, b) {
        if (!e.isEmpty(a)) {
          ...
          if ((b.noStrings !== !0 && e.isString(a) && (a = +a), !e.isNumber(a)))
            return (
              b.message || b.notValid || this.notValid || "is not a number"
            );
          ...
          for (c in g)
            if (((d = b[c]), e.isNumber(d) && !g[c](a, d))) {
              ...
              f.push(e.format(i, { count: d, type: e.prettify(c) }));
            }
          return (
            b.odd &&
              a % 2 !== 1 &&
              f.push(b.notOdd || this.notOdd || "must be odd"),
            b.even &&
              a % 2 !== 0 &&
              f.push(b.notEven || this.notEven || "must be even"),
          ...
          if (!e.isEmpty(a)) {
            ...
            return (
              ...
              isNaN(a) || (b.dateOnly && a % 864e5 !== 0)
                ? b.message || this.notValid || "must be a valid date"
                : (!isNaN(f) &&
                    f > a &&
                    ((c = this.tooEarly || "must be no earlier than %{date}"),
                    (c = e.format(c, { date: this.format(f, b) })),
                    d.push(c)),
                  !isNaN(g) &&
                    a > g &&
                    ((c = this.tooLate || "must be no later than %{date}"),
                    (c = e.format(c, { date: this.format(g, b) })),
                    d.push(c)),
                  d.length ? b.message || d : void 0)
            );
          }
        },
