  ...
  return (function(t) {
      ...
      function o(t) {
        for (var e = [], n = {}, r = 0; r < t.length; r++) {
          var o = t[r],
            ...
            a = o[2],
            c = o[3],
            f = { css: u, media: a, sourceMap: c };
          n[i] ? n[i].parts.push(f) : e.push((n[i] = { id: i, parts: [f] }));
        }
        return e;
      }
      function i(t, e) {
        ...
        T = (function() {
          function t() {
            ...
            if (n.rows.length) {
              ...
              var f = (this.dragger = u({
                dragging: !1,
                destroy: this.destroy
              }));
              f.on("drop", function(t, n, r, o) {
                ("column" === o ? e.sortColumn : e.sortRow)(t, n);
              });
              var l = void 0;
              if (a.dragHandler) {
                if (((l = n.querySelectorAll(a.dragHandler)), l && !l.length))
                  throw new Error(
              ...
              [
                {
                  ...
                  value: function() {
                    ...
                    try {
                      for (
                        var r, o = (0, l.default)(this.handlers);
                        !(t = (r = o.next()).done);
                        t = !0
                      ) {
                        var i = r.value;
    ...
    function(t, e, n) {
      ...
      t.exports = function(t, e, n, y, b, w, x) {
        ...
        var E,
          ...
          k = M[d] || M[v] || (b && M[b]),
          L = k || _(b),
          A = b ? (C ? _("entries") : L) : void 0,
          N = "Array" == e ? M.entries || k : k;
        if (
          (N &&
            ((T = s(N.call(new t()))),
            T !== Object.prototype &&
              (l(T, O, !0), r || a(T, d) || u(T, d, g))),
          C &&
            k &&
            k.name !== m &&
            ((j = !0),
          ...
          if (
            ((E = { values: C ? L : _(m), keys: w ? L : _(h), entries: A }), x)
          )
    ...
    function(t, e, n) {
      ...
      Y ||
        ...
        (n(66).f = Q),
        (n(65).f = tt),
        i && !n(14) && a(z, "propertyIsEnumerable", Q, !0),
        (v.f = function(t) {
          return K(p(t));
        })),
    ...
    function(t, e, n) {
      var r = n(46)("meta"),
        ...
        p = function(t) {
          return f && v.NEED && c(t) && !i(t, r) && l(t), t;
        },
        v = (t.exports = {
          KEY: r,
          NEED: !1,
        ...
        "Array",
        {
          from: function(t) {
            ...
            if (
              ...
              for (s = y.call(d), n = new p(); !(o = s.next()).done; g++)
                f(n, g, m ? u(s, h, [o.value, g], !0) : o.value);
            return (n.length = g), n;
          }
        }
      );
    ...
    function(t, e, n) {
      ...
      t.exports =
        ...
        n(26)(function() {
          ...
          ? function(t, e) {
              for (
                var n = u(t), c = arguments.length, f = 1, l = o.f, s = i.f;
                c > f;
    ...
    function(t, e, n) {
      ...
      function o(t) {
        (0, b.css)(t, {
          ...
          (0, l.default)(t.querySelectorAll("col")).forEach(function(t) {
      ...
      function i(t, e) {
        ...
        return (
          r.length &&
            (0, l.default)(r).forEach(function(t, n) {
              n !== e && t.parentElement.removeChild(t);
            }),
          (0, l.default)(n.rows).forEach(function(t) {
            var n = t.children[e];
      ...
      function u(t) {
        return (0, l.default)(t.rows).map(function(e) {
          var n = t.cloneNode(!0);
          o(n),
            (0, l.default)(n.children).forEach(function(t) {
              var e = t.nodeName;
      ...
      function a(t) {
        return (0, l.default)((0, b.getLongestRow)(t).children).map(function(
          e,
          n
        ) {
          return i(t, n);
            ...
            (0, v.default)(t, [
              ...
              },
              {
                ...
                value: function(t) {
                  ...
                  var u = r,
                    a = (0, l.default)(i.children).indexOf(t);
              ...
              },
              {
                ...
                value: function(t) {
                  var e = this.originTable.el,
                    ...
                    i = this.mode,
                    u = r,
                    a = (0, l.default)(o.children).indexOf(t);
              ...
              },
              {
                ...
                value: function() {
                  ...
                  var o = window
                    ...
                    u = n.children.length;
                  (0, l.default)(n.children).forEach(function(n, r) {
                    var a = n && n.querySelector("table");
                    t.options.onlyBody &&
                      "row" === e &&
                      !(0, l.default)(a.children).some(function(t) {
              ...
              },
              {
                ...
                value: function() {
                  ...
                  (0, l.default)((0, b.getLongestRow)(e).children).forEach(
                    function(e, n) {
                  ...
                  var n = (0, l.default)(e.rows).map(function(t) {
                    return t.children[0].getBoundingClientRect().height;
                  });
                  t.forEach(function(t) {
                    (0, l.default)(t.rows).forEach(function(t, e) {
                ...
                value: function() {
                  ...
                  t.forEach(function(t) {
                    (0, b.css)(t, { width: r + "px" }),
                      (0, l.default)(t.rows[0].children).forEach(function(
                        t,
                        e
                      ) {
                        (0, b.css)(t, {
    ...
    function(t, e, n) {
      (function(e) {
        ...
        function r(t, e) {
          function n(t) {
            return dt.containers.indexOf(t) !== -1 || st.isContainer(t);
          }
          function r(t) {
            var e = t ? "remove" : "add";
            o(T, e, "mousedown", C), o(T, e, "mouseup", R);
          }
          function a(t) {
            var e = t ? "remove" : "add";
            o(T, e, "mousemove", j);
          ...
          function h(t) {
            var e = t ? "remove" : "add";
            x[e](T, "selectstart", O), x[e](T, "click", O);
          }
          function y() {
            r(!0), R({});
          }
          ...
          function j(t) {
            if (ft) {
              ...
              if (
                ...
                if (st.ignoreInputTextSelection) {
                  var e = b("clientX", t),
                    n = b("clientY", t),
          ...
          function M(t) {
            if (!((dt.dragging && $) || n(t))) {
              ...
              if (
                ...
                !(
                  st.invalid(t, e) ||
                  (st.staticClass && t.classList.contains(st.staticClass))
                )
              ) {
                var o = st.moves(t, r, e, m(t));
          ...
          function I(t, e) {
            var n = p(t);
            at && st.copySortSource && e === Z && n.removeChild(tt),
          ...
          function D(t) {
            if (dt.dragging) {
              var e = arguments.length > 0 ? t : st.revertOnSpill,
                n = at || tt,
                r = p(n),
                o = z(r);
              o === !1 &&
          ...
          function U() {
            ...
            B(),
              ...
              ct && clearTimeout(ct),
              (dt.dragging = !1),
              lt && dt.emit("out", t, lt, Z),
              dt.emit("dragend", t),
              (Z = tt = at = it = ut = ct = lt = null);
          }
          function z(t, e) {
            var n;
            return (
              (n = void 0 !== e ? e : $ ? ut : m(at || tt)), t === Z && n === it
            );
          }
          function Y(t, e, r) {
            function o() {
          ...
          function X(t) {
            ...
            if ($) {
              ...
              var o = b("clientX", t),
                ...
                u = o - et,
                a = i - nt;
              ($.style.left = u + "px"), ($.style.top = a + "px");
              var f = at || tt,
                l = c($, o, i),
                s = Y(l, o, i),
                d = null !== s && s !== lt;
              (d || null === s) && (r(), (lt = s), n());
              var v = p(f);
              if (s === Z && at && !st.copySortSource)
                return void (v && v.removeChild(f));
              var h,
                y = J(s, l);
              if (null !== y) h = G(s, y, o, i);
              else {
                if (st.revertOnSpill !== !0 || at)
                  return void (at && v && v.removeChild(f));
                (h = it), (s = Z);
              }
              if ((null === h && d) || (h !== f && h !== m(f))) {
                ut = h;
                var w,
                  x = f.parentElement === s,
                  E = x && st.animation,
                  ...
                  T = st.direction,
                  O = "horizontal" === T ? t.pageX : t.pageY;
                if (
                  ((w =
                    O < _
                      ? h
                  ...
                  return;
                if (st.staticClass && w.classList.contains(st.staticClass))
                  return;
                var C = w && w.getBoundingClientRect();
                s.insertBefore(f, h),
                  E && w && C && (g(C, w, st.animation), g(S, f, st.animation)),
                  dt.emit("shadow", f, s, Z);
              }
            }
          }
          function W(t) {
          ...
          function K() {
            if (!$) {
              ...
              ($ = tt.cloneNode(!0)),
                ...
                E.rm($, "gu-transit"),
                E.add($, "gu-mirror"),
                st.mirrorContainer.appendChild($),
                o(T, "add", "mousemove", X),
                E.add(st.mirrorContainer, "gu-unselectable"),
                dt.emit("cloned", $, tt, "mirror");
            }
          }
          function q() {
            $ &&
              (E.rm(st.mirrorContainer, "gu-unselectable"),
          ...
          function G(t, e, n, r) {
            ...
            function i() {
              ...
              return u(a ? n > t.left + s(t) / 2 : r > t.top + d(t) / 2);
            }
            function u(t) {
              return t ? m(e) : e;
            }
            var a = "horizontal" === st.direction,
              c = e !== t ? i() : o();
            return c;
          }
          function V(t, e) {
            return "boolean" == typeof st.copy ? st.copy : st.copy(t, e);
          }
          var Q = arguments.length;
          1 === Q && Array.isArray(t) === !1 && ((e = t), (t = []));
          var $,
            Z,
            tt,
            et,
            ...
            lt = null,
            st = e || {};
          void 0 === st.moves && (st.moves = l),
            void 0 === st.accepts && (st.accepts = l),
            void 0 === st.invalid && (st.invalid = N),
            void 0 === st.containers && (st.containers = t || []),
            void 0 === st.isContainer && (st.isContainer = f),
            void 0 === st.copy && (st.copy = !1),
            void 0 === st.copySortSource && (st.copySortSource = !1),
            void 0 === st.revertOnSpill && (st.revertOnSpill = !1),
            void 0 === st.removeOnSpill && (st.removeOnSpill = !1),
            void 0 === st.direction && (st.direction = "vertical"),
            void 0 === st.ignoreInputTextSelection &&
              (st.ignoreInputTextSelection = !0),
            void 0 === st.mirrorContainer && (st.mirrorContainer = S.body),
            void 0 === st.animation && (st.animation = !1),
            void 0 === st.staticClass && (st.staticClass = "");
          var dt = w({
          ...
          return (
            st.removeOnSpill === !0 && dt.on("over", W).on("out", H), r(), dt
          );
        }
        function o(t, n, r, o) {
          var i = {
    ...
    function(t, e, n) {
      ...
      }.call(e, n(101).setImmediate, n(101).clearImmediate));
    },
    function(t, e) {
      function n() {
    ...
    function(t, e, n) {
      (function(e) {
        ...
        function o(t, e, n) {
          return t.attachEvent("on" + e, f(t, e, n));
        }
        function i(t, e, n, r) {
      ...
      var o = n(109),
        ...
        p =
          ((e.getTouchyEvent = function() {
            return l.navigator.pointerEnabled
          ...
          (e.touchy = function(t, e, n, r) {
            l.navigator.pointerEnabled
              ? f.default[e](t, d[n], r)
              : (f.default[e](t, s[n], r), f.default[e](t, n, r));
          }),
