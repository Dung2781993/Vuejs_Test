(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["tableDragger"] = factory();
  else root["tableDragger"] = factory();
})(this, function() {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        if (false) {
          ...
          if (!content.locals) {
            module.hot.accept(
              "!!./../node_modules/.npminstall/css-loader/0.26.1/css-loader/index.js!./main.css",
              function() {
	...
	*/
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var Drag = (function() {
          function Drag() {
            ...
            var options = (this.options = (0, _assign2.default)(
              {},
              defaults,
              userOptions
            ));
            ...
            if (options.dragHandler) {
              ...
              handlers =
                mode === "column"
                  ? table.rows[0]
                    ? table.rows[0].children
                    : []
                  : (0, _from2.default)(table.rows).map(function(row) {
            ...
            [
              {
                ...
                value: function bindEvents() {
                  ...
                  try {
                    for (
                      var _iterator = (0, _getIterator3.default)(this.handlers),
                        _step;
              ...
              },
              {
                ...
                value: function onTap(event) {
                  ...
                  var ignore =
                    !isLeftButton(event) || event.metaKey || event.ctrlKey;
                  if (ignore) {
                    return;
                  }
              ...
              },
              {
                ...
                value: function destroy() {
                  ...
                  try {
                    for (
                      var _iterator2 = (0, _getIterator3.default)(
                          this.handlers
                        ),
                        _step2;
        ...
        function emitter() {
          ...
          thing.emit = function(type) {
            ...
            try {
              for (
                var _iterator3 = (0, _getIterator3.default)(evt[type]), _step3;
      ...
      /***/ function(module, exports, __webpack_require__) {
        module.exports =
          ...
          !__webpack_require__(26)(function() {
            return (
              Object.defineProperty(__webpack_require__(27)("div"), "a", {
                get: function() {
                  return 7;
                }
              }).a != 7
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        __webpack_require__(20)(
          IteratorPrototype,
          __webpack_require__(50)("iterator"),
          function() {
            return this;
          }
        );
      ...
      /***/ function(module, exports, __webpack_require__) {
        module.exports =
          __webpack_require__(16).document && document.documentElement;
      ...
      /***/ function(module, exports, __webpack_require__) {
        var classof = __webpack_require__(78),
          ITERATOR = __webpack_require__(50)("iterator"),
          Iterators = __webpack_require__(32);
        module.exports = __webpack_require__(17).getIteratorMethod = function(
          it
        ) {
          if (it != undefined)
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _dragulaWithAnimation2 = _interopRequireDefault(
          _dragulaWithAnimation
        );
        ...
        var bodyPaddingRight =
          parseInt(document.body.style.paddingRight, 0) || 0;
          ...
          (0, _createClass3.default)(Dragger, [
            ...
            },
            {
              ...
              value: function destroy() {
                ...
                this.el.parentElement.classList.remove(
                  _classes2.default.dragging
                );
                if (!isTest) {
            ...
            },
            {
              ...
              value: function renderEl() {
                ...
                (0, _from2.default)(el.children).forEach(function(li, dex) {
                  ...
                  if (
                    _this3.options.onlyBody &&
                    mode === "row" &&
                    !(0, _from2.default)(table.children).some(function(o) {
            ...
            },
            {
              ...
              value: function sizeColumnFake() {
                ...
                (0, _from2.default)(
                  (0, _util.getLongestRow)(originEl).children
                ...
                var rowHeights = (0, _from2.default)(originEl.rows).map(
                  function(row) {
            ...
            },
            {
              ...
              value: function sizeRowFake() {
                ...
                fakeTables.forEach(function(t) {
                  (0, _util.css)(t, { width: w + "px" });
                  (0, _from2.default)(t.rows[0].children).forEach(function(
                    cell,
                    i
                  ) {
                    (0, _util.css)(cell, {
        ...
        function origin2DragItem(liTable) {
          ...
          (0, _from2.default)(liTable.querySelectorAll("col")).forEach(function(
            col
          ) {
        ...
        function buildColumnTables(table) {
          return (0, _from2.default)(
            (0, _util.getLongestRow)(table).children
        ...
        function buildTables(table, mode) {
          return mode === "column"
            ? buildColumnTables(table)
            : buildRowTables(table);
        }
          ...
          function dragula(initialContainers, options) {
            ...
            function canStart(item) {
              ...
              if (
                ...
                (o.staticClass && item.classList.contains(o.staticClass))
              ) {
                return;
              }
      ...
      /***/ function(module, exports, __webpack_require__) {
        /* WEBPACK VAR INJECTION */ (function(setImmediate, clearImmediate) {
          ...
          exports,
          __webpack_require__(101).setImmediate,
          __webpack_require__(101).clearImmediate
        ));
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var getLongestRow = (exports.getLongestRow = function getLongestRow(
          table
        ) {
        ...
        var appendSibling = (exports.appendSibling = function appendSibling(
          _ref
        ) {
          ...
          (parent || target.parentNode).insertBefore(
            target,
            origin ? origin.nextElementSibling : null
          );
        });

        var insertBeforeSibling = (exports.insertBeforeSibling = function insertBeforeSibling(
          _ref2
        ) {
