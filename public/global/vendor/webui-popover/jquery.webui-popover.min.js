...
!(function(a, b, c) {
  ...
  var e = "webuiPopover",
    ...
    h = {
      ...
      async: { type: "GET", before: null, success: null },
      cache: !0,
      multi: !1,
      arrow: !0,
      title: "",
      ...
      animation: null,
      template:
        '<div class="webui-popover"><div class="arrow"></div><div class="webui-popover-inner"><a href="#" class="close"></a><h3 class="webui-popover-title"></h3><div class="webui-popover-content"><i class="icon-refresh"></i> <p>&nbsp;</p></div></div></div>',
      backdrop: !1,
      dismissible: !0,
      onShow: null,
      onHide: null,
  ...
  (d.prototype = {
    ...
    displayContent: function() {
      ...
      "" === n && (n = this._defaults.height),
        ...
        d.detach().css({ top: m, left: m, display: "block" }),
      ...
      if (
        ...
        s.removeAttr("style"),
          "left" === j || "right" === j
            ? s.css({ top: this.$target.height() / 2 })
            : ("top" === j || "bottom" === j) &&
              s.css({ left: this.$target.width() / 2 }),
          o.arrowOffset &&
            (-1 === o.arrowOffset.left || -1 === o.arrowOffset.top
              ? s.hide()
              : s.css(o.arrowOffset));
      }
    ...
    getIframe: function() {
      ...
      return (
        a.each(this._defaults.iframeOptions, function(a) {
          "undefined" != typeof c.options.iframeOptions[a] &&
            b.attr(a, c.options.iframeOptions[a]);
        }),
        b
      );
    },
    ...
    getTargetPositin: function(a, b, d, e) {
      ...
      switch (b) {
        ...
        case "right":
          ...
          break;
        case "top-right":
          (p = { top: f.top - e, left: y ? f.left - t : s }),
            (q = { left: y ? Math.min(k, d) / 2 + t : m });
          break;
        case "top-left":
          (v = z ? t : -s),
            (p = { top: f.top - e, left: f.left - d + f.width + v }),
            (q = { left: z ? d - Math.min(k, d) / 2 - t : m });
          break;
        case "bottom-right":
          (p = { top: f.top + f.height, left: y ? f.left - t : s }),
            (q = { left: y ? Math.min(k, d) / 2 + t : m });
          break;
        case "bottom-left":
          (v = z ? t : -s),
            (p = { top: f.top + f.height, left: f.left - d + f.width + v }),
            (q = { left: z ? d - Math.min(k, d) / 2 - t : m });
          break;
        case "right-top":
          (v = B ? u : -s),
            (p = { top: f.top - e + f.height + v, left: f.left + f.width }),
            (q = { top: B ? e - Math.min(l, e) / 2 - u : m });
          break;
        case "right-bottom":
          (p = { top: A ? f.top - u : s, left: f.left + f.width }),
            (q = { top: A ? Math.min(l, e) / 2 + u : m });
          break;
        case "left-top":
          (v = B ? u : -s),
            (p = { top: f.top - e + f.height + v, left: f.left - d }),
            (q = { top: B ? e - Math.min(l, e) / 2 - u : m });
          break;
        case "left-bottom":
          (p = { top: A ? f.top - u : s, left: f.left - d }),
            (q = { top: A ? Math.min(l, e) / 2 + u : m });
      }
      return (
        (p.top += this.getOffsetTop()),
        (p.left += this.getOffsetLeft()),
        { position: p, arrowOffset: q }
      );
    }
  }),
    (a.fn[e] = function(b, c) {
