                ...
                <div class="list-group-item" data-plugin="editlist">
                  <div class="list-content">
                    ...
                    <div class="item-actions">
                      <span
                        class="btn btn-pure btn-icon"
                        data-toggle="list-editable"
                        ><i class="icon md-edit" aria-hidden="true"></i
                      ></span>
                      <span
                        class="btn btn-pure btn-icon"
                        data-toggle="list-delete"
                  ...
                  <div class="list-editable">
                    <div class="form-group form-material">
                      ...
                      <button
                        type="button"
                        class="input-editable-close icon md-close"
      ...
      >
        ...
        <div class="page-content-actions">
          <div class="float-right">
            ...
            <button type="button" class="btn btn-info btn-md empty-btn">
              Empty All
            </button>
          </div>
